...
public class WiredNegativeConditionPlayerHasBadgeEquipped extends WiredConditionPlayerHasBadgeEquipped {
     ...
     */
    public WiredNegativeConditionPlayerHasBadgeEquipped(long id, int itemId, Room room, int owner, String ownerName, int x, int y, double z, int rotation, String data) {
