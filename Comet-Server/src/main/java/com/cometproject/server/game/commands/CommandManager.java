...
public class CommandManager implements Initializable {
    ...
    public void loadStaffCommands() {
        ...
        this.commands.put(Locale.get("command.notification.name"), new NotificationCommand());
        this.commands.put(Locale.get("command.quickpoll.name"), new QuickPollCommand());

        // Room bundles
        this.commands.put(Locale.get("command.bundle.name"), new BundleCommand());
