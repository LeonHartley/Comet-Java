...
public class Events {
    ...
    public static final short ModerateThreadMessageEvent = 2683;
    public static final short UpdateThreadMessageEvent = 1764;
    ...
    public static final short EventLogMessageEvent = 2973;
