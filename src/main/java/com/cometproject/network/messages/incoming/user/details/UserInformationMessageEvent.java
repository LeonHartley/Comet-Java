...
import com.cometproject.network.messages.outgoing.messenger.LoadFriendsMessageComposer;
import com.cometproject.network.messages.outgoing.user.details.UserInfoMessageComposer;
import com.cometproject.network.messages.outgoing.user.details.WelcomeUserMessageComposer;
import com.cometproject.network.messages.outgoing.user.permissions.AllowancesMessageComposer;
import com.cometproject.network.messages.outgoing.user.purse.CurrenciesMessageComposer;
import com.cometproject.network.messages.outgoing.user.purse.SendCreditsMessageComposer;
