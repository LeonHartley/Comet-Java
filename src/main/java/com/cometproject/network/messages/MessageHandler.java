package com.cometproject.network.messages;

import com.cometproject.network.messages.headers.Events;
import com.cometproject.network.messages.incoming.IEvent;
import com.cometproject.network.messages.incoming.catalog.GetCataIndexMessageEvent;
import com.cometproject.network.messages.incoming.catalog.GetCataPageMessageEvent;
import com.cometproject.network.messages.incoming.catalog.HabboClubPackagesMessageEvent;
import com.cometproject.network.messages.incoming.catalog.PurchaseItemMessageEvent;
import com.cometproject.network.messages.incoming.catalog.data.GetShopData2MessageEvent;
import com.cometproject.network.messages.incoming.catalog.data.GetShopDataMessageEvent;
import com.cometproject.network.messages.incoming.catalog.groups.BuyGroupDialogMessageEvent;
import com.cometproject.network.messages.incoming.catalog.groups.BuyGroupMessageEvent;
import com.cometproject.network.messages.incoming.catalog.pets.PetRacesMessageEvent;
import com.cometproject.network.messages.incoming.handshake.CheckReleaseMessageEvent;
import com.cometproject.network.messages.incoming.handshake.GenerateSecretKeyMessageEvent;
import com.cometproject.network.messages.incoming.handshake.InitCryptoMessageEvent;
import com.cometproject.network.messages.incoming.handshake.SSOTicketMessageEvent;
import com.cometproject.network.messages.incoming.help.HelpTicketMessageEvent;
import com.cometproject.network.messages.incoming.help.InitHelpToolMessageEvent;
import com.cometproject.network.messages.incoming.messenger.AcceptFriendshipMessageEvent;
import com.cometproject.network.messages.incoming.messenger.PrivateChatMessageEvent;
import com.cometproject.network.messages.incoming.messenger.RequestFriendshipMessageEvent;
import com.cometproject.network.messages.incoming.moderation.ModToolBanUserMessageEvent;
import com.cometproject.network.messages.incoming.moderation.ModToolRoomChatlogMessageEvent;
import com.cometproject.network.messages.incoming.moderation.ModToolUserChatlogMessageEvent;
import com.cometproject.network.messages.incoming.moderation.ModToolUserInfoMessageEvent;
import com.cometproject.network.messages.incoming.navigator.*;
import com.cometproject.network.messages.incoming.room.action.*;
import com.cometproject.network.messages.incoming.room.bots.PlaceBotMessageEvent;
import com.cometproject.network.messages.incoming.room.engine.AddUserToRoomMessageEvent;
import com.cometproject.network.messages.incoming.room.engine.FollowRoomInfoMessageEvent;
import com.cometproject.network.messages.incoming.room.engine.InitalizeRoomMessageEvent;
import com.cometproject.network.messages.incoming.room.engine.LoadHeightmapMessageEvent;
import com.cometproject.network.messages.incoming.room.item.*;
import com.cometproject.network.messages.incoming.room.item.wired.SaveWiredMessageEvent;
import com.cometproject.network.messages.incoming.room.moderation.GetBannedUsersMessageEvent;
import com.cometproject.network.messages.incoming.room.moderation.GiveRightsMessageEvent;
import com.cometproject.network.messages.incoming.room.moderation.KickUserMessageEvent;
import com.cometproject.network.messages.incoming.room.moderation.RemoveAllRightsMessageEvent;
import com.cometproject.network.messages.incoming.room.settings.LoadRoomInfoMessageEvent;
import com.cometproject.network.messages.incoming.room.settings.SaveRoomDataMessageEvent;
import com.cometproject.network.messages.incoming.room.settings.UsersWithRightsMessageEvent;
import com.cometproject.network.messages.incoming.room.trading.*;
import com.cometproject.network.messages.incoming.user.club.ClubStatusMessageEvent;
import com.cometproject.network.messages.incoming.user.details.ChangeMottoMessageEvent;
import com.cometproject.network.messages.incoming.user.details.UserInformationMessageEvent;
import com.cometproject.network.messages.incoming.user.inventory.BadgeInventoryMessageEvent;
import com.cometproject.network.messages.incoming.user.inventory.BotInventoryMessageEvent;
import com.cometproject.network.messages.incoming.user.inventory.OpenInventoryMessageEvent;
import com.cometproject.network.messages.incoming.user.profile.GetProfileMessageEvent;
import com.cometproject.network.messages.incoming.user.profile.GetRelationshipsMessageEvent;
import com.cometproject.network.messages.incoming.user.profile.SetRelationshipMessageEvent;
import com.cometproject.network.messages.incoming.user.wardrobe.ChangeLooksMessageEvent;
