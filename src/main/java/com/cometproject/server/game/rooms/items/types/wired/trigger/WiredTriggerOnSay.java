...
public class WiredTriggerOnSay extends RoomItemFloor {
    private int state = -1;

    public WiredTriggerOnSay(int id, int itemId, int roomId, int owner, int x, int y, double z, int rotation, String data) {
