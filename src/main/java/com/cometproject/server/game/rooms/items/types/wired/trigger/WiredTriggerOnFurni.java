...
public class WiredTriggerOnFurni extends RoomItemFloor {
    private int state = -1;

    public WiredTriggerOnFurni(int id, int itemId, int roomId, int owner, int x, int y, double z, int rotation, String data) {
