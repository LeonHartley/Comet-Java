...
public class Composers {
    ...
    public static short SendCreditsMessageComposer =  1021; //3412;
    public static short CurrenciesMessageComposer = 1626; //1271;
    public static short HomeRoomMessageComposer = 854;
    public static short FuserightsMessageComposer = 335;//325;
    ...
    public static short AdvancedAlertMessageComposer = 372;//2372;
    public static short BoughtItemMessageComposer = 2434;
    public static short BuyGroupDialogMessageComposer = 1061;
    public static short CanCreateRoomMessageComposer = 2078; //3710;
    ...
    public static short HeightmapMessageComposer = 159; //3942;
    ...
    public static short LoadRightsOnRoomMessageComposer = 2922; //8;
    public static short ModelAndIdMessageComposer = 2388;//206; ROOM_READY
    public static short ModToolMessageComposer = 3563;
    public static short MotdMessageComposer = 367;
    public static short NavigatorFlatListMessageComposer = 2763;//1019;
    public static short OfferMessageComposer = 366;
    public static short OnCreateRoomInfoMessageComposer = 2897;
    public static short PapersMessageComposer = 2433; //2993;
    public static short PendingFriendsMessageComposer = 3942;
    public static short QuitRightsMessageComposer = 3185;
    public static short RelativeHeightmapMessageComposer = 1363; //2443;
    ...
    public static short TalkMessageComposer = 956; //1510;
