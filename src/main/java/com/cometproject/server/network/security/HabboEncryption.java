...
public class HabboEncryption {
    ...
    public HabboEncryption(BigInteger n, BigInteger e, BigInteger d) {
        this.rsa = new RSA(n, e.intValue(), d, new BigInteger("0"), new BigInteger("0"), new BigInteger("0"), new BigInteger("0"), new BigInteger("0"));
        this.diffieHellman = new DiffieHellman(200);//new DiffieHellman(PRIME, GENERATOR);
    }
