package com.cometproject.game.items.interactions;

import com.cometproject.boot.Comet;
import com.cometproject.game.GameEngine;
import com.cometproject.game.items.interactions.banzai.BanzaiPatchInteraction;
import com.cometproject.game.items.interactions.banzai.gates.BanzaiGateBlueInteraction;
import com.cometproject.game.items.interactions.banzai.gates.BanzaiGateGreenInteraction;
import com.cometproject.game.items.interactions.banzai.gates.BanzaiGateRedInteraction;
import com.cometproject.game.items.interactions.banzai.gates.BanzaiGateYellowInteraction;
import com.cometproject.game.items.interactions.football.BallInteraction;
import com.cometproject.game.items.interactions.items.*;
import com.cometproject.game.items.interactions.wired.action.WiredActionMoveRotate;
import com.cometproject.game.items.interactions.wired.action.WiredActionMoveUser;
import com.cometproject.game.items.interactions.wired.action.WiredActionShowMessage;
import com.cometproject.game.items.interactions.wired.trigger.WiredTriggerEnterRoom;
import com.cometproject.game.items.interactions.wired.trigger.WiredTriggerOnSay;
